...
public interface OrderTrackingRepository extends JpaRepository<OrderTracking, Long> {
    ...
    List<com.example.silea.entity.Order> findOrdersWithTrackingStatus(@Param("status") TrackingStatus status);
    ...
    List<com.example.silea.entity.Order> findOrdersWithDelayedTracking(@Param("threshold") LocalDateTime threshold);
    ...
    List<OrderTracking> findTrackingByOrderStatus(@Param("orderStatus") com.example.silea.enums.OrderStatus orderStatus);
}