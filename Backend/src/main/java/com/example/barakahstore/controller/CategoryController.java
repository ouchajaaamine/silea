...
import com.example.barakahstore.service.CategoryService;
...
public class CategoryController {
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Successfully retrieved all categories",
            content = @Content(mediaType = "application/json", example = "[{\"id\": 1, \"name\": \"Electronics\", \"nameArabic\": \"إلكترونيات\", \"description\": \"Electronic gadgets and devices\", \"active\": true}, {\"id\": 2, \"name\": \"Books\", \"nameArabic\": \"كتب\", \"description\": \"Various genres of books\", \"active\": true}]")),
        @ApiResponse(responseCode = "500", description = "Error retrieving categories",
            content = @Content(mediaType = "application/json", example = "{\"message\": \"Error retrieving categories: Internal Server Error\"}"))
    })
    ...
    @ApiResponses(value = {
        ...
        @ApiResponse(responseCode = "500", description = "Error retrieving active categories",
            content = @Content(mediaType = "application/json", example = "{\"message\": \"Error retrieving active categories: Internal Server Error\"}"))
    })
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Successfully retrieved category",
            content = @Content(mediaType = "application/json", example = "{\"id\": 1, \"name\": \"Electronics\", \"nameArabic\": \"إلكترونيات\", \"description\": \"Electronic gadgets and devices\", \"active\": true}")),
        @ApiResponse(responseCode = "404", description = "Category not found",
            content = @Content(mediaType = "application/json", example = "{\"message\": \"Category not found with ID: 1\"}")),
        @ApiResponse(responseCode = "500", description = "Error retrieving category",
            content = @Content(mediaType = "application/json", example = "{\"message\": \"Error retrieving category: Internal Server Error\"}"))
    })
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Category created successfully",
            content = @Content(mediaType = "application/json", example = "{\"success\": true, \"message\": \"Category created successfully\", \"category\": {\"id\": 3, \"name\": \"New Category\", \"nameArabic\": \"فئة جديدة\", \"description\": \"Description of new category\", \"active\": true}}")),
        @ApiResponse(responseCode = "400", description = "Invalid category data",
            content = @Content(mediaType = "application/json", example = "{\"success\": false, \"message\": \"Error creating category: Name cannot be empty\"}")),
        @ApiResponse(responseCode = "500", description = "Error creating category",
            content = @Content(mediaType = "application/json", example = "{\"success\": false, \"message\": \"Error creating category: Internal Server Error\"}"))
    })
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Category updated successfully",
            content = @Content(mediaType = "application/json", example = "{\"success\": true, \"message\": \"Category updated successfully\", \"category\": {\"id\": 1, \"name\": \"Updated Electronics\", \"nameArabic\": \"إلكترونيات محدثة\", \"description\": \"Updated description\", \"active\": true}}")),
        @ApiResponse(responseCode = "400", description = "Invalid category data",
            content = @Content(mediaType = "application/json", example = "{\"success\": false, \"message\": \"Error updating category: Name cannot be empty\"}")),
        @ApiResponse(responseCode = "404", description = "Category not found",
            content = @Content(mediaType = "application/json", example = "{\"success\": false, \"message\": \"Category not found with ID: 1\"}")),
        @ApiResponse(responseCode = "500", description = "Error updating category",
            content = @Content(mediaType = "application/json", example = "{\"success\": false, \"message\": \"Error updating category: Internal Server Error\"}"))
    })
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Category status updated successfully",
            content = @Content(mediaType = "application/json", example = "{\"success\": true, \"message\": \"Category status updated successfully\", \"category\": {\"id\": 1, \"name\": \"Electronics\", \"nameArabic\": \"إلكترونيات\", \"description\": \"Description\", \"active\": true}}")),
        @ApiResponse(responseCode = "404", description = "Category not found",
            content = @Content(mediaType = "application/json", example = "{\"success\": false, \"message\": \"Category not found with ID: 1\"}")),
        @ApiResponse(responseCode = "500", description = "Error updating category status",
            content = @Content(mediaType = "application/json", example = "{\"success\": false, \"message\": \"Error updating category status: Internal Server Error\"}"))
    })
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Category deleted successfully",
            content = @Content(mediaType = "application/json", example = "{\"success\": true, \"message\": \"Category deleted successfully\"}")),
        @ApiResponse(responseCode = "404", description = "Category not found",
            content = @Content(mediaType = "application/json", example = "{\"success\": false, \"message\": \"Category not found with ID: 1\"}")),
        @ApiResponse(responseCode = "500", description = "Error deleting category",
            content = @Content(mediaType = "application/json", example = "{\"success\": false, \"message\": \"Error deleting category: Internal Server Error\"}"))
    })
    ...
    @ApiResponses(value = {
        ...
        @ApiResponse(responseCode = "500", description = "Error searching categories",
            content = @Content(mediaType = "application/json", example = "{\"message\": \"Error searching categories: Internal Server Error\"}"))
    })
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Successfully retrieved category statistics",
            content = @Content(mediaType = "application/json", example = "{\"totalCategories\": 5, \"activeCategories\": 3, \"inactiveCategories\": 2}")),
        @ApiResponse(responseCode = "500", description = "Error retrieving category statistics",
            content = @Content(mediaType = "application/json", example = "{\"message\": \"Error retrieving category statistics: Internal Server Error\"}"))
    })
