...
import com.example.barakahstore.service.UserService;
import com.example.barakahstore.service.AuthService;
...
public class UserController {
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Login successful",
            content = @Content(mediaType = "application/json", schema = @Schema(implementation = User.class), example = "{\"success\": true, \"message\": \"Login successful\", \"token\": \"eyJhbGciOiJIUzI1NiJ9...\", \"user\": {\"id\": 1, \"email\": \"admin@example.com\", \"name\": \"Admin User\"}}")),
        @ApiResponse(responseCode = "401", description = "Invalid credentials",
            content = @Content(mediaType = "application/json", example = "{\"success\": false, \"message\": \"Invalid email or password\"}"))
    })
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Email check completed",
            content = @Content(mediaType = "application/json", example = "{\"exists\": true}")),
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Profile retrieved successfully",
            content = @Content(mediaType = "application/json", example = "{\"id\": 1, \"email\": \"admin@example.com\", \"name\": \"Admin User\"}")),
        @ApiResponse(responseCode = "401", description = "Unauthorized - JWT token required",
            content = @Content(mediaType = "application/json", example = "{\"message\": \"Unauthorized\"}")),
        @ApiResponse(responseCode = "404", description = "User not found",
            content = @Content(mediaType = "application/json", example = "{\"message\": \"User not found\"}"))
    })
